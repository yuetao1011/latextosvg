...
Multiline equations (must define number of columns used ({lcl})) (should not be used unless needed) | $\begin{array}{lcl} z & = & a \\ f(x,y,z) & = & x + y + z \end{array}$ | \begin{array}{lcl}<br>z & = & a \\\\<br>f(x,y,z) & = & x + y + z<br>\end{array} 
